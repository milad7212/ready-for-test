  ...
  return (
    <div className=" mx-auto max-w-7xl px-4">
      <div className="my-20 mx-auto flex flex-col items-center justify-between sm:flex-row">
        <div className="mb-3 flex items-center self-start sm:mb-0">
          <svg
          ...
          <h1 className="text-2xl inline-block  font-black text-gray-700  sm:text-4xl">
            منابع آزمون
              ...
              <div className="flex w-full flex-1 flex-col space-y-2">
                <div className=" flex flex-grow flex-col px-4">
                  ...
                  <Link
                    ...
                    href={`/test/book/${resource.number}`}
                  ...
                  <div className="px-4 pb-1">
                    <div className>
                      <div className="flex items-center justify-between">
                        {/* show presell */}
                        <div className="rounded bg-red-200 px-2"></div>
                        {/* show offer price */}
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
